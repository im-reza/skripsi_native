    ...
    while ($us_kabag=mysqli_fetch_array($kabag)) {
      ...
      $jabatan=$us_kabag['jabatan'];
		...
		$query = mysqli_query($con,"SELECT * FROM surat_masuk INNER JOIN file inner join disposisi on surat_masuk.no_surat=file.no_surat and surat_masuk.no_surat=disposisi.no_surat where surat_masuk.status='1' and disposisi.penerima='$user' ORDER BY disposisi.status_ds ASC");
      ...
      <tr>
          ...
          <div class="widget-content p-0">
            <div class="widget-content-wrapper">
              ...
              <div class="widget-content-left flex2">
                <div class="widget-heading"><?php echo $nama_kabag; ?></div>
                <div class="widget-subheading opacity-7"><?php echo $jabatan; ?></div>
              </div>
            </div>
          </div>
        </td>
        <td class="text-center"><?php echo $d['no_surat']; ?></td>
        <td class="text-center"><?php echo $d['perihal']; ?></td>
        ...
        <td>
          <?php if ($d['status_ds']=='0') {
            echo "<a href='actions/aksi_baca_ds.php?id=".$d['id_ds']."' class='btn btn-sm btn-info'>Tandai Dibaca</a>";
          }else{
